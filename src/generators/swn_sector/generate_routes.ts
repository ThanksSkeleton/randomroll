...
export function generateRoutes(
  ...
  for (const [index, edge] of selected.entries()) {
    ...
    Routes.push({
      ...
      Intelligence: {
        InfoboxSummary: `${edge.left.NiceName} to ${edge.right.NiceName}.`,
        BasicScan: 'Interstellar route.',
        CulturePartial: '',
        CultureFull: '',
        GM: '',
      },
    ...
    for (const [side, other, id] of [
      ...
      RoutePortals.push({
        ...
        VisibilityLevel: 'NONE',
        Intelligence: {
          InfoboxSummary: `Route portal to ${other.NiceName}.`,
          BasicScan: 'Interstellar route portal.',
          CulturePartial: '',
          CultureFull: '',
          GM: '',
        },
